...
New presets, such as `"crypto"`, `"iot"`, `"healthcare"`, are explicitly welcome as contributions. Each check that branches on `domain` needs one additional clause with justified thresholds.
